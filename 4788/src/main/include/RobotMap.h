...
struct RobotMap {
  ...
  struct IntakeSystem {
    ...
    wml::actuators::DoubleSolenoid intakeSolenoidRight{ ControlMap::PCModule, ControlMap::IntakeSolenoidPort, 0.1 };
    wml::actuators::DoubleSolenoid intakeSolenoidLeft{ ControlMap::PCModule, ControlMap::IntakeSolenoidPort, 0.1 };
